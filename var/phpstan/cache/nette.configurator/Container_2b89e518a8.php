...
class Container_2b89e518a8 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_2b89e518a8 $container)
			{
	...
	public function createServiceContainer(): Container_2b89e518a8
	{
		return $this;
	}
