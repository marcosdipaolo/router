...
class Container_081c02c306 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_081c02c306 $container)
			{
	...
	public function createServiceContainer(): Container_081c02c306
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'generateBaselineFile' => '/Users/marcosdipaolo/Documents/dev/own/router/phpstan-baseline.neon',
			'usedLevel' => '9',
