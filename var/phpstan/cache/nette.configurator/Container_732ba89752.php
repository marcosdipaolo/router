...
class Container_732ba89752 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
		...
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				[
					'message' => '#^Cannot cast mixed to string\.$#',
					'count' => 1,
					'path' => '/Users/marcosdipaolo/Documents/dev/own/router/src/Router/UrlGenerator.php',
				],
				[
					'message' => '#^Binary operation "\." between \'User \' and mixed results in an error\.$#',
					'count' => 1,
					'path' => '/Users/marcosdipaolo/Documents/dev/own/router/test/Router/MockedController.php',
				],
				[
				...
				[
					...
					'count' => 1,
					'path' => '/Users/marcosdipaolo/Documents/dev/own/router/test/Router/RouterTest.php',
				],
			],
			true
		);
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_732ba89752 $container)
			{
	...
	public function createService066(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'/Users/marcosdipaolo/Documents/dev/own/router/phpstan-baseline.neon',
			],
			null,
			[
				'phar:///Users/marcosdipaolo/Documents/dev/own/router/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
	...
	public function createServiceContainer(): Container_732ba89752
	{
		return $this;
	}
